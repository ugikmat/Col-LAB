...
import id.poros.filkom.col_lab.model.EventContent.EventItem;
...
public class EventRecyclerViewAdapter extends RecyclerView.Adapter<EventRecyclerViewAdapter.ViewHolder> {
    ...
    public EventRecyclerViewAdapter(List<EventItem> items, OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
